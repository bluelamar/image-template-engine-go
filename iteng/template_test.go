...
func TestParseInputs(t *testing.T) {
	...
	if inputs["motif"] != "./testdata/arrow_100x100.png" {
		t.Errorf("Expected motif to be './testdata/arrow_100x100.png', but got '%s'", inputs["motif"])
	}
...
func TestParseTemplate(t *testing.T) {
	...
	if templ.TemplateImage != "testdata/sun_and_moon_100x100.png" {
